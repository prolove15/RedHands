    ...
    public class HandlesExtra
    {
        ...
        public class Styles
        {
            ...
            public Styles()
            {
                ...
                dotCyan.normal.background = Resources.Load<Texture2D>("Anima2D/dotCyan");

                dotYellow.fixedWidth = 8f;
                dotYellow.fixedHeight = 8f;
                dotYellow.normal.background = Resources.Load<Texture2D>("Anima2D/dotYellow");

                dotRed.fixedWidth = 8f;
                dotRed.fixedHeight = 8f;
                dotRed.normal.background = Resources.Load<Texture2D>("Anima2D/dotRed");

                dotBlackBig.fixedWidth = 23.5f;
                dotBlackBig.fixedHeight = 23.5f;
                dotBlackBig.normal.background = Resources.Load<Texture2D>("Anima2D/dotBlackBig");

                dotYellowBig.fixedWidth = 23.5f;
                dotYellowBig.fixedHeight = 23.5f;
                dotYellowBig.normal.background = Resources.Load<Texture2D>("Anima2D/dotYellowBig");
            }
        }
